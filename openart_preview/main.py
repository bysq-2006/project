...
GRID_DETECT_CONFIG = {
    ...
    "color_ratios": (
        ("wall", ((0, 100, -10, 74, -79, 12),), 0.25),
        ("goal", ((47, 80, 56, 106, -76, -23),), 0.25),
        ("background", ((32, 59, 22, 67, -106, -64),), 0.25),
    ),
...
TARGETS = (
    ...
    ("cyan_marker", ((69, 100, -80, -16, -40, 39),), (0, 255, 255), 25),
    ("green_marker", ((68, 100, -99, -23, -26, 92),), (0, 255, 0), 25),
